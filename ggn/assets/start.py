...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/tricky_bots")],
...
async def term_command(event):
    ...
    buttons = [
        [Button.url("Query?", url="https://t.me/Chat_support_cc_bot"),
         Button.url("Channel", url="https://t.me/tricky_bots")]
    ]
...
REPO_URL = "https://t.me/tricky_bots"
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Save Restricted Bot](https://t.me/save_restrict11_free_bot)**__"  # Set caption to the title of the video
